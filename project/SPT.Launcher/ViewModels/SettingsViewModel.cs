...
namespace SPT.Launcher.ViewModels
{
    public class SettingsViewModel : ViewModelBase
    {
        ...
        // Свойства для повторных попыток соединения
        public bool EnableRetryConnection
        {
            get => LauncherSettingsProvider.Instance.EnableRetryConnection;
            set
            {
                LauncherSettingsProvider.Instance.EnableRetryConnection = value;
                this.RaisePropertyChanged();
            }
        }
        ...
        {
            get => LauncherSettingsProvider.Instance.RetryAttempts;
            set
            {
                LauncherSettingsProvider.Instance.RetryAttempts = value;
                this.RaisePropertyChanged();
            }
        }
        ...
        {
            get => LauncherSettingsProvider.Instance.RetryDelay;
            set
            {
                LauncherSettingsProvider.Instance.RetryDelay = value;
                this.RaisePropertyChanged();
            }
        }
    }
